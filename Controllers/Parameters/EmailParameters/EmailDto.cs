...
namespace GamingCommunityApi.Controllers.Parameters.EmailParameters
{
    ...
    public class EmailDto
    {
        ...
        public static OpenApiObject PureEmailExample1 { get; } = new OpenApiObject
        {
            ...
            [nameof(ActivationStatus).ToSnakeCase()] = new OpenApiString(Enums.ActivationStatus.COMPLETED.ToString()),
